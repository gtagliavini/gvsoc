...
pulp_nn_insns = [
    ...
    # mac & load 16-bit operands
    R5('pv.mlsdotup.h.0', 'RRRR', '1010000 ----- ----- 000 ----- 1110111'),
    R5('pv.mlsdotup.h.1', 'RRRR', '1010001 ----- ----- 000 ----- 1110111'),
    R5('pv.mlsdotup.h.2', 'RRRR', '1010010 ----- ----- 000 ----- 1110111'),
    R5('pv.mlsdotup.h.3', 'RRRR', '1010011 ----- ----- 000 ----- 1110111'),

    R5('pv.mlsdotusp.h.0', 'RRRR', '1010100 ----- ----- 000 ----- 1110111'),
    R5('pv.mlsdotusp.h.1', 'RRRR', '1010101 ----- ----- 000 ----- 1110111'),
    R5('pv.mlsdotusp.h.2', 'RRRR', '1010110 ----- ----- 000 ----- 1110111'),
    R5('pv.mlsdotusp.h.3', 'RRRR', '1010111 ----- ----- 000 ----- 1110111'),

    R5('pv.mlsdotsup.h.0', 'RRRR', '1001100 ----- ----- 000 ----- 1110111'),
    R5('pv.mlsdotsup.h.1', 'RRRR', '1001101 ----- ----- 000 ----- 1110111'),
    R5('pv.mlsdotsup.h.2', 'RRRR', '1001110 ----- ----- 000 ----- 1110111'),
    R5('pv.mlsdotsup.h.3', 'RRRR', '1001111 ----- ----- 000 ----- 1110111'),

    R5('pv.mlsdotsp.h.0', 'RRRR', '1011100 ----- ----- 000 ----- 1110111'),
    R5('pv.mlsdotsp.h.1', 'RRRR', '1011101 ----- ----- 000 ----- 1110111'),
    R5('pv.mlsdotsp.h.2', 'RRRR', '1011110 ----- ----- 000 ----- 1110111'),
    R5('pv.mlsdotsp.h.3', 'RRRR', '1011111 ----- ----- 000 ----- 1110111'),

    # mac & load 8-bit operands
    R5('pv.mlsdotup.b.0', 'RRRR', '1010000 ----- ----- 001 ----- 1110111'),
    R5('pv.mlsdotup.b.1', 'RRRR', '1010001 ----- ----- 001 ----- 1110111'),
    R5('pv.mlsdotup.b.2', 'RRRR', '1010010 ----- ----- 001 ----- 1110111'),
    R5('pv.mlsdotup.b.3', 'RRRR', '1010011 ----- ----- 001 ----- 1110111'),

    R5('pv.mlsdotusp.b.0', 'RRRR', '1010100 ----- ----- 001 ----- 1110111'),
    R5('pv.mlsdotusp.b.1', 'RRRR', '1010101 ----- ----- 001 ----- 1110111'),
    R5('pv.mlsdotusp.b.2', 'RRRR', '1010110 ----- ----- 001 ----- 1110111'),
    R5('pv.mlsdotusp.b.3', 'RRRR', '1010111 ----- ----- 001 ----- 1110111'),

    R5('pv.mlsdotsup.b.0', 'RRRR', '1001100 ----- ----- 001 ----- 1110111'),
    R5('pv.mlsdotsup.b.1', 'RRRR', '1001101 ----- ----- 001 ----- 1110111'),
    R5('pv.mlsdotsup.b.2', 'RRRR', '1001110 ----- ----- 001 ----- 1110111'),
    R5('pv.mlsdotsup.b.3', 'RRRR', '1001111 ----- ----- 001 ----- 1110111'),

    R5('pv.mlsdotsp.b.0', 'RRRR', '1011100 ----- ----- 001 ----- 1110111'),
    R5('pv.mlsdotsp.b.1', 'RRRR', '1011101 ----- ----- 001 ----- 1110111'),
    R5('pv.mlsdotsp.b.2', 'RRRR', '1011110 ----- ----- 001 ----- 1110111'),
    R5('pv.mlsdotsp.b.3', 'RRRR', '1011111 ----- ----- 001 ----- 1110111'),

    # mac & load 4-bit operands
    R5('pv.mlsdotup.n.0', 'RRRR', '1010000 ----- ----- 010 ----- 1110111'),
    R5('pv.mlsdotup.n.1', 'RRRR', '1010001 ----- ----- 010 ----- 1110111'),
    R5('pv.mlsdotup.n.2', 'RRRR', '1010010 ----- ----- 010 ----- 1110111'),
    R5('pv.mlsdotup.n.3', 'RRRR', '1010011 ----- ----- 010 ----- 1110111'),

    R5('pv.mlsdotusp.n.0', 'RRRR', '1010100 ----- ----- 010 ----- 1110111'),
    R5('pv.mlsdotusp.n.1', 'RRRR', '1010101 ----- ----- 010 ----- 1110111'),
    R5('pv.mlsdotusp.n.2', 'RRRR', '1010110 ----- ----- 010 ----- 1110111'),
    R5('pv.mlsdotusp.n.3', 'RRRR', '1010111 ----- ----- 010 ----- 1110111'),

    R5('pv.mlsdotsup.n.0', 'RRRR', '1001100 ----- ----- 010 ----- 1110111'),
    R5('pv.mlsdotsup.n.1', 'RRRR', '1001101 ----- ----- 010 ----- 1110111'),
    R5('pv.mlsdotsup.n.2', 'RRRR', '1001110 ----- ----- 010 ----- 1110111'),
    R5('pv.mlsdotsup.n.3', 'RRRR', '1001111 ----- ----- 010 ----- 1110111'),

    R5('pv.mlsdotsp.n.0', 'RRRR', '1011100 ----- ----- 010 ----- 1110111'),
    R5('pv.mlsdotsp.n.1', 'RRRR', '1011101 ----- ----- 010 ----- 1110111'),
    R5('pv.mlsdotsp.n.2', 'RRRR', '1011110 ----- ----- 010 ----- 1110111'),
    R5('pv.mlsdotsp.n.3', 'RRRR', '1011111 ----- ----- 010 ----- 1110111'),

    # mac & load 2-bit operands
    R5('pv.mlsdotup.c.0', 'RRRR', '1010000 ----- ----- 011 ----- 1110111'),
    R5('pv.mlsdotup.c.1', 'RRRR', '1010001 ----- ----- 011 ----- 1110111'),
    R5('pv.mlsdotup.c.2', 'RRRR', '1010010 ----- ----- 011 ----- 1110111'),
    R5('pv.mlsdotup.c.3', 'RRRR', '1010011 ----- ----- 011 ----- 1110111'),

    R5('pv.mlsdotusp.c.0', 'RRRR', '1010100 ----- ----- 011 ----- 1110111'),
    R5('pv.mlsdotusp.c.1', 'RRRR', '1010101 ----- ----- 011 ----- 1110111'),
    R5('pv.mlsdotusp.c.2', 'RRRR', '1010110 ----- ----- 011 ----- 1110111'),
    R5('pv.mlsdotusp.c.3', 'RRRR', '1010111 ----- ----- 011 ----- 1110111'),

    R5('pv.mlsdotsup.c.0', 'RRRR', '1001100 ----- ----- 011 ----- 1110111'),
    R5('pv.mlsdotsup.c.1', 'RRRR', '1001101 ----- ----- 011 ----- 1110111'),
    R5('pv.mlsdotsup.c.2', 'RRRR', '1001110 ----- ----- 011 ----- 1110111'),
    R5('pv.mlsdotsup.c.3', 'RRRR', '1001111 ----- ----- 011 ----- 1110111'),

    R5('pv.mlsdotsp.c.0', 'RRRR', '1011100 ----- ----- 011 ----- 1110111'),
    R5('pv.mlsdotsp.c.1', 'RRRR', '1011101 ----- ----- 011 ----- 1110111'),
    R5('pv.mlsdotsp.c.2', 'RRRR', '1011110 ----- ----- 011 ----- 1110111'),
    R5('pv.mlsdotsp.c.3', 'RRRR', '1011111 ----- ----- 011 ----- 1110111'),
